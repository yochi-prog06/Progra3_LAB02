...
public class Estudiante extends Persona implements Comparable <Estudiante>{
    ...
    //constructores
    public Estudiante(String edad, String nombre, String carnet, String carrera) {
        super(edad, nombre);
        this.carnet = carnet;
    ...
    public Estudiante(String edad, String nombre, String carnet, String carrera, List<Double> notas) {
